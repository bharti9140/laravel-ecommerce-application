...
@if ($errors) @foreach($errors as $key => $value)
    <div class="alert alert-danger alert-dismissible" role="alert" style="width:280px">
...
@if ($info) @foreach($info as $key => $value)
    <div class="alert alert-info alert-dismissible" role="alert" style="width:280px">
        <button class="close" type="button" data-dismiss="alert">×</button>
...
@if ($warnings) @foreach($warnings as $key => $value)
    <div class="alert alert-warning alert-dismissible" role="alert" style="width:280px">
        <button class="close" type="button" data-dismiss="alert">×</button>
